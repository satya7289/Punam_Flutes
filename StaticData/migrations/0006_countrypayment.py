...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('StaticData', '0005_auto_20210425_1530'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('razorpay', models.BooleanField(blank=True, default=True, null=True)),
                ('paypal', models.BooleanField(blank=True, default=True, null=True)),
                ('cod', models.BooleanField(blank=True, default=True, null=True)),
            ],
            options={
                'abstract': False,
            },
